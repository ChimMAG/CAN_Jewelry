...
using static canjewelry.src.utils.InfoDisplay;

namespace canjewelry.src.be
{
    public abstract class CANBEBasePSContainer : BlockEntityDisplay, IPurposefulStorageContainer
    {
        public InventoryGeneric inv;
        protected CANBasePSContainer block;
        ...
        {
            block ??= api.World.BlockAccessor.GetBlock(Pos) as CANBasePSContainer;
            base.Initialize(api);
        ...
        {
            blockMesh = Meshing.GenBlockVariantMesh(Api, this.GetVariantStack());
        }
        ...
        public override void OnBlockPlaced(ItemStack byItemStack = null)
        {
            ...
            if (byItemStack?.Attributes[CANBasePSContainer.PSAttributes] is ITreeAttribute tree)
            {
        ...
        public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldForResolving)
        {
            ...
            VariantAttributes = tree[CANBasePSContainer.PSAttributes] is ITreeAttribute fsTree
                ? fsTree
                : new TreeAttribute();
        ...
        public override void ToTreeAttributes(ITreeAttribute tree)
        {
            ...
            {
                tree[CANBasePSContainer.PSAttributes] = VariantAttributes;
            }
        }
